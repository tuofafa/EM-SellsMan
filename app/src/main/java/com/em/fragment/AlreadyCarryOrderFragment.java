 ...
 * @author fafatuo
 * @version 1.0
 * @date 2020/9/27 0027 14:09
 * discrption  累计订单模块  已提现fragment
 */
public class AlreadyCarryOrderFragment extends Fragment {

    private static final String TAG ="AlreadyCarryOrderFragment";
