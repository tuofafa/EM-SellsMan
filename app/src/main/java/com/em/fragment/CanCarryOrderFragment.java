 ...
 * @author fafatuo
 * @version 1.0
 * @date 2020/9/27 0027 14:06
 * discrption 累计订单模块 可提现fragment
 */
public class CanCarryOrderFragment extends Fragment {
    private static final String TAG ="CanCarryOrderFragment";
            ...
            if(flag.equals("true") && !(data.equals("null"))){
                ...
                if(pageSize>0){
                    for(int i=0;i<array.length();i++){
                        ...
                        if(saleState != null && saleState == 2){
                            order.setYognJinStatus("可提现");
