 ...
 * @author fafatuo
 * @version 1.0
 * @date 2020/9/27 0027 14:02
 * discrption 累计订单模块 预计收益frgment
 */
public class ExceptOrderFragment extends Fragment {
    private static final String TAG ="ExceptOrderFragment";
            ...
            if(flag.equals("true") && !(data.equals("null"))){
                ...
                if(pageSize>0){
                    for(int i=0;i<array.length();i++){
                        ...
                        //只统计预计收益类型的
                        if(saleState != null && saleState == 1){
                            order.setYognJinStatus("预计收益");
